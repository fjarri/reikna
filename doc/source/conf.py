...
project = 'reikna'
copyright = '2012-2014, Bogdan Opanchuk'
...
# documentation.
html_theme_options = {'github_fork': 'Manticore/reikna'}
...
latex_documents = [
  ('index', 'reikna.tex', 'reikna Documentation',
...
man_pages = [
    ('index', 'reikna', 'reikna Documentation',
     ['Bogdan Opanchuk'], 1)
]
...
texinfo_documents = [
  ('index', 'reikna', 'reikna Documentation',
   'Bogdan Opanchuk', 'reikna', 'One line description of project.',
   'Miscellaneous'),
]
