...
For more information proceed to the `project documentation page <http://reikna.publicfields.net>`_. If you have a general question that does not qualify as an issue, you can ask it on a `discussion forum <https://groups.google.com/d/forum/reikna>`_.
